...
#整个上期所18个品种
#contract_0100pool=['cu','al','zn','pb','ni','sn','rb','hc','bu','au','ag','ru','wr','ss','sc','fu','nr','sp']

#整个大商所19个品种
#contract_0100pool=['p','j','a','b','m','y','jm','i','l','v','pp','eg','c','cs','jd','rr','fb','bb','eb']
#整个郑商所20个品种
contract_0100pool=['CF','SR','RM','TA','MA','OI','FG','ZC','PM','WH','RI','LR','JR','RS','CY','AP','CJ','SF','SM','UR']





for contract_type in contract_0100pool:
    #contract_type='al'
